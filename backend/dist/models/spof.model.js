...
const spofSchema = new mongoose_1.Schema({
    employee: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true },
    knowledgeAreas: [
        {
            area: { type: String, required: true },
            score: { type: Number, required: true, min: 0, max: 100 },
            relatedItems: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Knowledge" }],
        },
    ],
...
exports.default = mongoose_1.default.model("SPOF", spofSchema);
